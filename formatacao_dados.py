...
class ListaColuna:
    ...
    def __init__( self ) -> None:
        ...
        self.quantidade_hora_produtiva = 'Quantidade produtiva'
        self.quantidade_hora_improdutiva = 'Quantidade improdutiva'
        self.quantidade_hora_total = 'Quantidade hora total'
